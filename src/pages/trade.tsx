  ...
  return (
    <SwapUIContextProvider>
      ...
      <PageLayout mobileBarTitle="Solana-Dex" metaTitle="Solana-Dex">
        ...
        <Row className="justify-center  mb-12 mobile:mb-2 gap-8">
          <SwapCard type={mode} />
          <SwapCard1 type={mode} />
        </Row>
  ...
  return (
    <Row className="justify-center  mb-12 mobile:mb-2">
      <Tabs
        ...
        values={['buy', 'sell']}
        onChange={(newTab) => {
          if (newTab === 'sell') routeTo('/liquidity/add')
        }}
      />
    </Row>
  )
    ...
    >
      ...
      <div className="space-y-5 mt-5 mobile:mt-0">
        <CoinInputBox
          ...
          // hideTransferFee
        />
        <Row className="relative flex-col bg-[#141041] cursor-text rounded-xl py-3 px-6 mobile:px-4 pointer-events-none-entirely cursor-default opacity-50">
        ...
        <Row className="relative flex-col bg-[#141041] cursor-text rounded-xl py-3 px-6 mobile:px-4 pointer-events-none-entirely cursor-default opacity-50">
          <Col className="items-start">
            <div className="text-[rgb(171,196,255)] h-5 max-w-[7em] min-w-[2em] overflow-hidden text-ellipsis font-medium text-base flex-grow mobile:text-sm whitespace-nowrap"></div>
          </Col>
        </Row>
        {/* swap button */}
        ...
        validators={[
          ...
          },
          {
            ...
            fallbackProps: {
              ...
              children: connecting ? 'Connecting...' : 'Buy'
            }
          },
          {
...
function SwapCard1({ type }) {
  ...
  return (
    ...
    >
      {/* input twin */}
      <AllUnwrapSOLToSol />
      <div className="space-y-5 mt-5 mobile:mt-0 text-center h-[360px]">
        <h2>Order Book</h2>
        <Row className="relative flex-col justify-between gap-5 bg-[#141041] cursor-text rounded-xl py-3 px-6 mobile:px-4 pointer-events-none-entirely cursor-default opacity-50">
          <Row className="flex justify-between">
            <Col className="items-start">Buyer</Col>
            <Col className="items-start"></Col>
            <Col className="items-start">Seller</Col>
          </Row>
          <Row className="flex justify-between">
            <Col className="items-start">Size (BLOW)</Col>
            <Col className="items-start">Price (USDC)</Col>
            <Col className="items-start">Size (BLOW)</Col>
          </Row>
        </Row>
        {/* <Row className="relative flex-col bg-[#141041] cursor-text rounded-xl py-3 px-6 mobile:px-4 pointer-events-none-entirely cursor-default opacity-50">
